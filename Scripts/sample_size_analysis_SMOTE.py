...
if __name__ == "__main__":
    ...
    for name_antibiotic in antibiotic_df.columns[1:]:
        ...
        np.savetxt("SMOTE_backward_elimination_test_AUC_"+name_antibiotic+".csv", results_array_test, delimiter=",")
        np.savetxt("SMOTE_backward_elimination_train_AUC_"+name_antibiotic+".csv", results_array_train, delimiter=",")
        np.savetxt("SMOTE_backward_elimination_samples_id_"+name_antibiotic+".csv", id_samples_array, delimiter=",")
